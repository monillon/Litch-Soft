...
public class Tissue {
    ...
    private int idTissue; // Identifiant de l'organe. Ne peut être négatif ou nul.La vérification de l'unicité est laissée à la base de données
    private String nameTissue; // Nom de l'organe. Ne peut être nul ou vide.
    ...
    public Tissue(int newIdTissue, String newNameTissue){
        ...
        if (newNameTissue == null|| newNameTissue.length() < 1)  throw new IllegalArgumentException("Ne peut pas être null ou négatif");
