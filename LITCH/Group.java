 ...
 */
public class Group {
    private int idGroup; //identifiant du groupe géré par la base de donnée
    private String codeGroup; // Code du groupe afin d'être identifié
    private String nameGroup; // Nom du groupe Le nom du groupe
    private boolean groupPatho; //if true : groupe pathologique | if false : groupe non pathologique
    private boolean groupTreated; // if true : groupe traité | if false : groupe non traité
    private int nbMembers; // nombre de membres dans le groupe
    private Organism organism; // type d'organisme traité : humain, rat ou organe
    private ArrayList<Subject> subjectList; // Liste des sujets dans le groupe
