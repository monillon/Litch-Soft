...
public class Organ {
    ...
    private int idOrgan; // Identifiant de l'organe. Ne peut être négatif ou nul.La vérification de l'unicité est laissée à la base de données
    private String nameOrgan; // Nom de l'organe. Ne peut être nul ou vide.
    ...
    public Organ(int newIdOrgan, String newNameOrgan){
        ...
        if (newNameOrgan == null|| newNameOrgan.length() < 1)  throw new IllegalArgumentException("Ne peut pas être null ou négatif");
        idOrgan = newIdOrgan;
